...
　利用方法は、通常の３カラムテーマと殆ど同じですが、さらに中央中央カラムについて
...
　これらについては、theme.html内の７３行目付近に直書きされていますので、適宜のurlに変更する等してご利用ください。（不要であれば、	<div id="information">～</div><{* end information *}> を削除してください。）
